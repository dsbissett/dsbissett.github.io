...
export class TetrisAiDiagnosticsService {
  ...
  public logReplayBufferEntry(
    ...
    console.log(
      `%c📦 REPLAY BUFFER %csize=${size}/${maxSize} %cstep=${stepCount} %creward=${reward >= 0 ? '+' : ''}${reward.toFixed(4)} done=${done}`,
